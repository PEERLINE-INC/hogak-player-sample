import { g as P, u as g, p as b } from "./index-Dq-62_9z.js";
import v from "react";
function O(t, e) {
...
var S = Object.create, l = Object.defineProperty, w = Object.getOwnPropertyDescriptor, j = Object.getOwnPropertyNames, C = Object.getPrototypeOf, D = Object.prototype.hasOwnProperty, E = (t, e, r) => e in t ? l(t, e, { enumerable: !0, configurable: !0, writable: !0, value: r }) : t[e] = r, L = (t, e) => {
  ...
  t
)), T = (t) => d(l({}, "__esModule", { value: !0 }), t), n = (t, e, r) => (E(t, typeof e != "symbol" ? e + "" : e, r), r), h = {};
L(h, {
  default: () => u
});
...
class u extends p.Component {
  constructor() {
    super(...arguments), n(this, "callPlayer", c.callPlayer), n(this, "duration", null), n(this, "currentTime", null), n(this, "fractionLoaded", null), n(this, "mute", () => {
      this.setVolume(0);
    }), n(this, "unmute", () => {
...
n(u, "canPlay", M.canPlay.soundcloud);
n(u, "loopOnEnded", !0);
